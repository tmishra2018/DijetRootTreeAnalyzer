...
void SimpleDiJetFitV1()
{
  ...
  //########################
  // MC QCD all  
  char input_root_file[500] = "../scripts/plots/histo_bkg_mjj.root";
  ...
  // #1 : random dataset 
  //1 Gev binning
  TH1F* hist_mass_1GeV = new TH1F("hist_mass_1GeV", "", 13999, 1., 14000. );
  ...
  //10fb-1
  //hist_mass_1GeV->FillRandom(hist_mass_original, 10*int(hist_mass_original->Integral()));

#!usr/bin/python
import ROOT
from ROOT import TFile, TH1F, THStack, TCanvas, TMath, gROOT, gPad, TLegend, TPad, TString, TF1, TFitResultPtr
...
file_debug = TFile("plot_debug.root","recreate")
file_debug.cd()

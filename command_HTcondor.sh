...
condor_submit config_File=config/cutFile_mainGammaplusJetSelection_Newsmearing.txt output_name=TEST_condor name_list=test_prefix dir_list=dir_list_test/ Njob=1  Submit_to_HTcondor.sub

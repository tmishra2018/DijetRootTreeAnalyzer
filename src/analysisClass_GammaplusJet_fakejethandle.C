  ...
  :baseClass(inputList, cutFile, treeName, outputFileName, cutEfficFile)
{
  ...
  if( int(getPreCutValue1("useJECs"))==1 )
  {
    ...
    std::string L1RCcorrDATAPath = "data/Spring16_25nsV6_DATA/Spring16_25nsV6_DATA_L1RC_AK4PFchs.txt";
    std::string L1RCcorrMCPath = "data/Spring16_25nsV3_MC/Spring16_25nsV3_MC_L1RC_AK4PFchs.txt";

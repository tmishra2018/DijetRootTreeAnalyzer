...
for line in  ins:
  ...
  for jj in range(0,njobs_list[i_f]+1):
    ...
    #outputfile.write("xrdcp /tmp/rootfile_"+sample+"_"+newTag+"_"+str(jj)+"_reduced_skim.root root://eoscms/"+opt.output+"/rootfile_"+sample+"_"+newTag+"_"+str(jj)+"_reduced_skim.root\n")
    #outputfile.write("xrdcp /tmp/rootfile_"+sample+"_"+newTag+"_"+str(jj)+".root root://eoscms/"+opt.output+"/rootfile_"+sample+"_"+newTag+"_"+str(jj)+".root\n")
    #outputfile.write("xrdcp /tmp/cutEfficiencyFile_"+sample+"_"+newTag+"_"+str(jj)+".dat root://eoscms/"+opt.output+"/cutEfficiencyFile_"+sample+"_"+newTag+"_"+str(jj)+".dat\n")

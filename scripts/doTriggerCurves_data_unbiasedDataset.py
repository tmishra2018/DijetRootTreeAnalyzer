...
h_mjj_HLTpass_noTrig_all = h_mjj_HLTpass_noTrig_list[0].Clone("h_mjj_HLTpass_noTrig_all")
...
h_mjj_HLTpass_noTrig_all.Print()
h_mjj_HLTpass_PFHT475_all.Print()
h_mjj_HLTpass_PFHT800_all.Print()
...
g_eff[0].SetName("g_eff_PFHT475")
g_eff[1].SetName("g_eff_PFHT800")
...
g_ineff[1].GetXaxis().SetRangeUser(1000,2037)
g_ineff[1].GetYaxis().SetRangeUser(0,4)
g_ineff[1].GetXaxis().SetTitle("mjj [GeV]")
g_ineff[1].GetYaxis().SetTitle("#frac{(1-eff)}{relative stat. uncertainty}")
g_ineff[1].GetYaxis().SetTitleSize(0.02)
g_ineff[1].GetYaxis().SetTitleOffset(0.05)
g_ineff[1].UseCurrentStyle()
...
g_eff[1].GetXaxis().SetRangeUser(minX_mass,maxX_mass)
g_eff[1].GetYaxis().SetRangeUser(0.8,1.05)
g_eff[1].Draw("AP")
#g_eff[1].Draw("P SAME")
#g_eff[2].Draw("P SAME")
l.Draw()
...
h_mjj_HLTpass_noTrig_all.SetLineColor(1)  
h_mjj_HLTpass_PFHT800_all.SetLineColor(2)  
h_mjj_HLTpass_noTrig_all.GetXaxis().SetTitle("mjj [GeV]")  
h_mjj_HLTpass_noTrig_all.GetYaxis().SetTitle("events")  
h_mjj_HLTpass_noTrig_all.GetXaxis().SetRangeUser(minX_mass,maxX_mass)  
...
c2.cd()
c2.SetLogy(1)
h_mjj_HLTpass_noTrig_all.Draw()
#h_mjj_HLTpass_PFHT475_all.Draw("same")
...
l2.AddEntry(h_mjj_HLTpass_noTrig_all,"no Trigger","l")
...
g_eff[1].Write()
#g_eff[2].Write()
h_mjj_HLTpass_noTrig_all.Write()

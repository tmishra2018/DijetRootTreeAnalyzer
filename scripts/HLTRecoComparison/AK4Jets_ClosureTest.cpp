...
int main(int argc, char* argv[]) {
  ...
  std::string outputDir = "AK4JetsClosureTest_Plot";                 
  mkdir(outputDir.c_str(), 0777); 

  TString dataFileName_DoubleMu;
  dataFileName_DoubleMu = TString::Format("../../output/HLTReco_ClosureTest/rootFile_JEC_HLT_v7_RecoLowerCuts10GeV_WideEtaBin_ClosureTest_DoubleMu.root");
  ...
  dataFileName_HT450 = TString::Format("../../output/HLTReco_ClosureTest/rootFile_JEC_HLT_v7_RecoLowerCuts10GeV_WideEtaBin_ClosureTest_HT450.root");
  ...
  for (size_t ii = 0; ii < etaBinningSize; ii++) {
	...
	h -> Fit(doublecrystal, "R");
      ...
      */
      ...
      ExponentialGauss->SetParLimits(3, 0.2, 2.0);
      ExponentialGauss->SetParLimits(4, 0.2, 2.0);
      if( jj>= 8 ) ExponentialGauss->SetParLimits(2, 0.005, 0.025);
      //    if( jj>= 8 ) ExponentialGauss->SetParLimits(3, 0.2, 2.0);
      // if( jj>= 8 ) ExponentialGauss->SetParLimits(4, 0.2, 2.0);
      ...
      h  -> Draw();
      c1 -> SaveAs( Form("AK4JetsClosureTest_Plot/%s.png", HistoName.c_str() ) );
      c1 -> Destructor();
  ...
  for(int ii = 0; ii < etaBinningSize ; ii++){ 
   ...
   // functionFit -> SetParLimits(3, 0, 10000);
    ...
    lineup2 -> Draw("same");
    linedown2 -> Draw("same");
    c1 -> SaveAs( Form("AK4JetsClosureTest_Plot/%s.png", TGraphName.c_str() ) );
    c1 -> Destructor();
  ...
  /*
    ...
    c2->SaveAs("AK4JetsClosureTest_Plot/Corrections.png");
